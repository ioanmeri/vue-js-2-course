  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        <h1>Animations</h1>
        <hr>
        <h2>Bind the name of Animation with Select</h2>
        ...
        <h3>Using custom CSS classes and <strong>animate.css</strong> library</h3>
        <transition  
                appear
        ...
        <hr>
        <h2>Animation in JavaScript</h2>
        <button class="btn btn-prm" @click="load = !load">Load / Remove Element</button>
        <br><br>
        <transition 
